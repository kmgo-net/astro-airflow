...
default_args={
    "owner": "Arkadiusz Tyszecki,Open in Cloud IDE",
}

@dag(
    default_args=default_args,
    schedule=None,
    start_date=pendulum.from_format("2024-01-16", "YYYY-MM-DD"),
    catchup=False,
    owner_links={
        "Arkadiusz Tyszecki": "mailto:arek.tyszecki@gmail.com",
        "Open in Cloud IDE": "https://cloud.astronomer.io/clrgc385v05ur01qzvjc48xfz/cloud-ide/clrgc4gad05ut01qzuyyyf15s/clrgc4gkm003o01ngfse8oxpe",
    },
)
